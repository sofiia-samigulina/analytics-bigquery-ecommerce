...
RAW_DATASET_NAME = 'raw_ecommerce'
RAW_DATASET_ID = f'{MY_PROJECT_ID}.{RAW_DATASET_NAME}'
CLEANED_DATASET_NAME = 'staging'
CLEANED_DATASET_ID = f'{MY_PROJECT_ID}.{CLEANED_DATASET_NAME}'
